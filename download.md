...
**点击这里下载安装包 ===> [植物大战僵尸β版整合包v1.3.0.exe](https://www.lanzous.com/i9nfw2b) <=== 点击这里下载安装包**


如果不想安装，也可以下载免安装压缩包：[植物大战僵尸β版整合包v1.3.0.7z](https://www.lanzous.com/i9nfwmb)

如果出现字体不清晰的状况，请打开 3D 加速。安装包安装时勾选“字体优化”（默认已勾选）即可自动打开 3D 加速。

**如果因为打开3D加速导致游戏无法正常运行，请下载 [close-3d.reg](/close-3d.reg)，双击运行即可关闭3D加速。**

整合包路径中 `PlantsVsZombies.exe` 是β版最新版本（5.70）的游戏文件，同时整合包里同时提供了 5.21 ~ 5.65 版本的 exe，相应文件名称是 `beta版本号.exe`，想玩较老版本直接打开对应的 exe 即可。
...
如果想尝试更早版本的游戏（β5.21 ~ β5.70），可以在此处寻找你想尝试的版本的 exe 下载：
