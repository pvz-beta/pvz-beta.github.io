...
**点击这里下载安装包 ===> [植物大战僵尸β版整合包v1.4.1.exe](https://www.lanzous.com/ia7zv6j) <=== 点击这里下载安装包**

注意：因为修复了一些崩溃问题，以及加入游戏开始时的弹窗，从 β5.60 开始游戏可能会被一些杀软误报为病毒。


如果不想安装，也可以下载免安装压缩包：[植物大战僵尸β版整合包v1.4.1.7z](https://www.lanzous.com/ia7zu2j)

如果出现字体不清晰的状况，请打开 3D 加速。安装包安装时勾选“字体优化”（默认已勾选）即可自动打开 3D 加速。

**如果因为打开3D加速导致游戏无法正常运行，请下载 [close-3d.reg](/close-3d.reg)，双击运行即可关闭3D加速。**

整合包路径中 `PlantsVsZombies.exe` 是β版最新版本（β5.75）的游戏文件，同时整合包里同时提供了 5.21 ~ 5.70 版本的 exe，相应文件名称是 `beta版本号.exe`，想玩较老版本直接打开对应的 exe 即可。
